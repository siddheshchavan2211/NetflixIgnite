  ...
  return (
    <div className="h-full bg-black bg-gradient-to-r from-dark-start to-dark-end text-white">
      <div className="h-full min-h-full">
        ...
        <div className="mx-12 pt-24">
          ...
          <div className="border-white-700 relative h-[35rem] w-full overflow-hidden rounded-3xl border border-t-2">
            ...
            <button
              ...
              className="absolute bottom-4 right-4 rounded-full bg-white px-4 py-2 text-black shadow-lg focus:outline-none"
            >
              {isPlaying ? (
                <svg
        ...
        <section className="rounded-xl px-4 py-12 text-white">
          <h2 className="mb-8 text-center text-3xl font-bold">
            More reasons to join
          </h2>
          <div className="mx-auto grid max-w-7xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            {/* Card 1 */}
            <div className="rounded-lg bg-gradient-to-tl from-fuchsia-950 p-6 text-center shadow-lg">
              <h3 className="mb-4 text-xl font-semibold">Enjoy on your TV</h3>
              <p className="mb-6 text-sm text-gray-400">
                Watch on smart TVs, PlayStation, Xbox, Chromecast, Apple TV,
                Blu-ray players and more.
              </p>
              <div className="default-ltr-cache-1nu0xuw ml-44">
            ...
            {/* Card 3 */}
            <div className="rounded-lg bg-gradient-to-tl from-fuchsia-950 p-6 text-center shadow-lg">
              <h3 className="mb-4 text-xl font-semibold">Watch everywhere</h3>
              <p className="mb-6 text-sm text-gray-400">
                Stream unlimited movies and TV shows on your phone, tablet,
                laptop and TV.
              </p>
              <div className="default-ltr-cache-1nu0xuw ml-44 mt-14">
                <svg width="72" height="72" viewBox="0 0 72 72" fill="none">
